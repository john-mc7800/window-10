...
export default function SidebarList({ list, title, icon, imageSrc }) {
    ...
    return (
        <div>
            <div className={`items-star hover:bg-blue-300 hover:bg-opacity-80 py-1 grid grid-cols-[10%_10%_1fr] gap- pl-2 items-center ${isExpanded ? 'bg-neutral-00 hover:outline hover:outline-1 hover:outline-blue-500' : ''}`} onDoubleClick={toggleExpand} >
