...
export default function MenuBar({ onClose }) {
  ...
  return (
    <>
      <div className='flex flex-row text-xs items-center cursor-context-menu fixed text-black'>
      ...
      {fileIsOpen && (
        <div ref={menuRef} className="w-[650px] h-[300px] relative -top-9 z-10 bg-white border mt-8  text-black">
